            ...
            {Array.from(Array(4).keys()).map((ele, index) => {
              return (
                <Box className={"review_box"} key={index}>
                  ...
                  <span className={"review_name"}>Rayxon Asadova</span>
              ...
              return (
                <Box display={"flex"} flexDirection={"row"} key={index}>
                  ...
                  <div className={"about_right_desc"}>
                    <span>Bizning oshpazlarimiz</span>
                    <p>
                      Bizning oshpazlarimiz dunyo taniydigon oliygohlarda
                      malakasini oshirishib kelishgan
                    </p>
                  </div>
                </Box>
              );
